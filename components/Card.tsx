...
export default function Card({
  ...
  return (
    ...
    >
      <div className="card-body flex sm:justify-center justify-center relative sm:w-full sm:h-[500px] md:h-[550px] lg:h-[600px] xl:h-[650px] h-[230px] w-[160px] mx-auto rounded-lg">
        <img
          src={src}
          alt={productName}
